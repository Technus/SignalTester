...
public abstract class ComplexDoublePropertyBase extends DoubleProperty {
    ...
    /**
     * The constructor of the {@code ComplexDoublePropertyBase}.
     */
    public ComplexDoublePropertyBase() {
    }
     ...
     */
    public ComplexDoublePropertyBase(double initialValue) {
    ...
    public void bind(final ObservableValue<? extends Number> rawObservable) {
        ...
        if (!newObservable.equals(observable)) {
            ...
            if (listener == null) {
                listener = new ComplexDoublePropertyBase.Listener(this);
            }
    ...
    /**
     * Returns a string representation of this {@code ComplexDoublePropertyBase} object.
     * @return a string representation of this {@code ComplexDoublePropertyBase} object.
     */
    @Override
    ...
    private static class Listener implements InvalidationListener {
        ...
        private final WeakReference<ComplexDoublePropertyBase> wref;

        public Listener(ComplexDoublePropertyBase ref) {
            this.wref = new WeakReference<>(ref);
        }

        @Override
        public void invalidated(Observable observable) {
            ComplexDoublePropertyBase ref = wref.get();
            if (ref == null) {
    ...
    public final void setRawValue(double newValue){
        if (value != newValue) {
            value = newValue;
            markInvalid();
        }
