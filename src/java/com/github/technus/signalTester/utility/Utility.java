...
public class Utility {
    ...
    public static Consumer<ErrorLog> errorConsumer;
    ...
    public static void logError(Throwable t){
        ...
        fullDocument.put("error",
                new BasicDBObject("message",t.getMessage())
                        .append("details", sw.toString())
                        .append("name",t.getClass().getSimpleName())
                        .append("application","Signal tester"));
        errorConsumer.accept(fullDocument);
    }
}
