package java.com.github.technus.signalTester.db.mongoDB.codecs;
...
public class ClassNameCodec implements Codec<Class> {
    public static final Codec<Class> INSTANCE=new ClassNameCodec();
